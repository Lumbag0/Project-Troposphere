...
class Countries:
    class United_States:
        ...
        @staticmethod
        def get_states():
            return list(Countries.United_States.__states.keys())
        ...
        def get_state_abbr(state):
            state_abbr = Countries.United_States.__states.get(state)["abbr"]
        ...
        def get_capital(state):
            state_capital = Countries.United_States.__states.get(state)["capital"]
        ...
        def get_capital_coord(state):
            coord = Countries.United_States.__states.get(state)["capital_coord"]
